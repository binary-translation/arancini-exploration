...
ExternalProject_Add(mbuild
    ...
    GIT_TAG
        "f32bc9b31f9fc5a0be3dc88cd2086b70270295ab"
    GIT_PROGRESS
        ON
    GIT_SHALLOW
        ON
...
# Download and patch mbuild We want to use the same keystone version as NixOS
# (as of 2024-04-29)
ExternalProject_Add(external-xed
    GIT_REPOSITORY
        "https://github.com/intelxed/xed.git"
    GIT_TAG
        "b86dd5014463d954bc8898d2376b14852d26facd"
    GIT_PROGRESS
        ON
    GIT_SHALLOW
        ON
...
configure_file("${CMAKE_CURRENT_SOURCE_DIR}/cmake/XEDConfig.cmake.in" "${CMAKE_INSTALL_PREFIX}/lib/cmake/XED/XEDConfig.cmake" @ONLY)
