...
inline void slli(InstructionBuilder &builder, TypedRegister &out_reg, const TypedRegister &src_reg, intptr_t amt)
{
...
inline void srli(InstructionBuilder &builder, TypedRegister &out_reg, const TypedRegister &src_reg, intptr_t amt)
{
	switch (out_reg.type().element_width()) {
	case 128:
...
inline void srai(InstructionBuilder &builder, TypedRegister &out_reg, const TypedRegister &src_reg, intptr_t amt)
{
	switch (out_reg.type().element_width()) {
	case 64:
...
inline void sll(InstructionBuilder &builder, TypedRegister &out_reg, const TypedRegister &src_reg, const TypedRegister &amt_reg)
{
	switch (out_reg.type().element_width()) {
	case 64:
...
inline void srl(InstructionBuilder &builder, TypedRegister &out_reg, const TypedRegister &src_reg, const TypedRegister &amt_reg)
{
	switch (out_reg.type().element_width()) {
	case 64:
...
inline void sra(InstructionBuilder &builder, TypedRegister &out_reg, const TypedRegister &src_reg, const TypedRegister &amt_reg)
{
	switch (out_reg.type().element_width()) {
	case 64:
