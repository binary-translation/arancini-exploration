...
static inline uint64_t native_syscall(uint64_t syscall_no, Args... arg1);
...
template <>
inline uint64_t native_syscall(uint64_t syscall_no, uint64_t arg1,
                               uint64_t arg2) {
    register uint64_t a0 __asm__("a0") = arg1;
...
inline uint64_t native_syscall(uint64_t syscall_no, uint64_t arg1,
    ...
    __asm__ volatile("syscall"
                     : "+a"(retval)
                     : "D"(arg1), "S"(arg2), "d"(arg3), "r"(r8), "r"(r9),
                       "r"(r10)
                     : "memory", "rcx", "r11");
    return retval;
}
